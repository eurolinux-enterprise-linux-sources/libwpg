...
*/
bool libwpg::WPGraphics::generateSVG(WPXInputStream* input, libwpg::WPGString& output)
{
...
bool libwpg::WPGraphics::generateSVG(const unsigned char* data, const size_t size, libwpg::WPGString& output)
{
	WPGInternalInputStream tmpStream(data, size);
	return libwpg::WPGraphics::generateSVG(&tmpStream, output);
}
